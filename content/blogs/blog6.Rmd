...
#  Death rate across gender, age and if the patient was admitted to Intensive care unit or not

```  {r}

#first the data has to be filtered to exclude missing values. icu_yn refers to weather the patient was admitted to icu or not
